...
import { SettingChokaiFormProps } from '@/utils/types';
import {
  BarsArrowDownIcon,
  BookmarkIcon,
  LightBulbIcon,
      ...
      <div className="flex mb-2">
        ...
        <div className="ms-2 text-sm">
          ...
          <p className="text-xs font-normal text-gray-500">
            Hiển thị nút nhấn, để click vào đó sẽ hiển thị script
          </p>
        </div>
      </div>
      <div className="flex mb-2">
...
export default SettingChokaiForm;
